...
export default function EditUser()
{
    ...
    const getUser=async()=>{
        const response=await (await axios.get(`https://611f26749771bf001785c74e.mockapi.io/users/${param}`)).data
    ...
    {
       try{
        let response= await axios.put(`https://611f26749771bf001785c74e.mockapi.io/users/${param}`,{           
